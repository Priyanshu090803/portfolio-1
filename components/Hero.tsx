      ...
      <div className="space-y-6 w-full ">
        ...
        <div className="space-y-6 mt-8 w-full">
          <div className="w-full flex items-baseline gap-3">
            <h3 className="text-5xl px-3 text-neutral-600 dark:text-neutral-300">
              I am a Full Stack Dev.
            </h3>

            <span className="text-neutral-400 text-sm dark:hidden">
              — I write clean code at day
            </span>
            <span className="text-neutral-200 text-sm dark:block hidden">
            ...
            <p className="text-neutral-400 dark:text-neutral-300 leading-relaxed">
              ...
              {techStack.map((tech) => {
                ...
                return (
                  ...
                  dark:border-neutral-700 text-neutral-600 dark:text-neutral-300 text-sm font-light
